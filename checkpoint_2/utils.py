...
def binarize_data(img=None, k=None, bilateral_filter=None,
    ...
    Returns
    -------
    segmented_image, porosity  : ndarray
    ...
    if bilateral_filter:
        bilateral = cv2.bilateralFilter(pixel_vals, d, sigmaColor, sigmaSpace) 
        retval, labels, centers = cv2.kmeans(bilateral, k, None, criteria, 10, cv2.KMEANS_RANDOM_CENTERS)
    else:
    ...
    return segmented_image, porosity
